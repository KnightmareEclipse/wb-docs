...
*   Servertyp `cx33` (4 vCPU shared, 8GB RAM, 80GB NVMe SSD — für DB+API+Caddy+Logging einer kleinen Schule ausreichend dimensioniert), Region `fsn1`/`nbg1` (Falkenstein/Nürnberg, Deutschland — einfachste DSGVO-Begründung ohne Drittland-Transfer), beide als Konstante in `vps/infra/`.
