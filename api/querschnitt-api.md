...
| `DELETE /persons/{person_id}/consents/{purpose}` — sie widerrufen, und über denselben Weg jedes Newsletter- und Schulinformations-Thema abwählen | [10](../soll-prozesse/10-ferienprogramm.md) „Was dabei erhoben wird", [00](../soll-prozesse/00-zugang-und-portal.md) „Mails und Schreiben" | Erziehungsberechtigte; `secretariat` | die eigene Antwort. **Trägt die Kategorie `requires_family_recipient`, weist die Route die Abwahl des Letzten ab** — „einer je Familie muss sie bekommen" spannt über zwei Personenzeilen und ist deshalb kein Constraint; scheidet der zweite Sorgeberechtigte aus, schaltet der Lösch-Lauf den Verbliebenen wieder ein | schreibt, `guardian:` / `entra:` | — |
