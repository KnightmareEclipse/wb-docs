...
| „Das hausinterne Q5-Ziel steht (`in_house`)" | **bleibt dort** als Feststellung: Es ist eine Zeile in `sync_targets`, keine Route. Die zweite hausinterne Aufgabe („Putzdienstjahr einrichten", 04 Z4) nimmt dasselbe Ziel und läuft über `PUT /tasks/{id}` |
