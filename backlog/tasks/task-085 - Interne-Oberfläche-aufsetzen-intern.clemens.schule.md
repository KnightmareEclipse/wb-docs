...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Drei Bedingungen für den Teams-Tab: frame-ancestors für teams.microsoft.com und *.cloud.microsoft, kein X-Frame-Options, validDomains im Manifest, gültiges HTTPS
