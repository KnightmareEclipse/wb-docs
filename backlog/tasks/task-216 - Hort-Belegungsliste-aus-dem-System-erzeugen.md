...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Jede Sicht ist frisch erzeugt und liest den Bestand, keine wird gepflegt
...
- [x] #5 Bei der Abrechnungsliste ist entschieden, ob sie rechnet oder zusammenstellt
<!-- AC:END -->
