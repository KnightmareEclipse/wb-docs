...
**Drei verworfene Wege samt Preis**, damit sie nicht neu erfunden werden: Nur die Ankunftszeit zu führen spart eine Spalte, wirft aber das Unterrichtsende weg — die Abholzeit jedes Kindes ohne Hortvertrag. Ein Häkchen „Sport" plus feste Verzögerung ist falsch an zwei Stellen: Die Rückfahrtdauer hängt an der Halle, und der nächste Grund bräuchte ein zweites Häkchen. Und die Abweichung je **Datum** statt je Wochentag träfe auch den Wandertag, wäre für die wöchentliche Sportabweichung aber jede Woche eine Zeile, die jemand einträgt — die Pflege, die liegen bleibt. Käme der einmalige Fall doch, ist er eine Tabelle **daneben** und kein Umbau dieser einen.
