...
`[?]` **Zwei Punkte für die Hortleitung**, beide in einem Satz zu beantworten und deshalb nicht in fragen.md: Gibt es eine Platzgrenze, kann eine Portalbuchung also abgelehnt werden? Und wird eine gebuchte, aber nicht wahrgenommene Betreuung berechnet?
