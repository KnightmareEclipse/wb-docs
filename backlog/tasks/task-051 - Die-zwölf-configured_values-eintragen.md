...
**Der zwölfte kam mit der Notfallbetreuung dazu** (TASK-214, 04.09.2026): meal_single_amount_cents, das einzelne Mittagessen ohne Abo, 5,90 € je Fall aus Block 11. Es fällt an, wo ein Fall der Notfallbetreuung über Mittag reicht, und steht in configured_values statt in meal_prices, weil es weder je Modul noch je Schulart verschieden ist (schema/mensa-schema.sql). Der Betrag steht, der Gültigkeitstag fehlt.
