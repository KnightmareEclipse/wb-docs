...
- **Mittelfristig:** auch die Microsoft-365-Kontenverwaltung abdecken (aktuell über Vis365, ein Tool des Microsoft-Vermittlers, mit Einschränkungen wie max. 2 Kontaktpersonen pro Kind). **Eine vollständige Ablösung hängt nicht am Identitätsteil, sondern an der Geräteverwaltung:** Sie steckt im Premium-Paket, das den Kontenteil ohnehin enthält — wer nur Konten und Gruppen übernimmt, baut nach, wofür weiter gezahlt wird. Ausgeschlossen ist auch sie nicht, sie steht nur weit hinten.
...
steht in keiner Zuteilung und in keiner Mail dieses Prozesses. Und von den beiden `configured_values` des
Putzdiensts hält nur die Strafe keinen Lauf an, solange sie außen vor bleibt; der Freikaufbetrag ist ab Zyklus
