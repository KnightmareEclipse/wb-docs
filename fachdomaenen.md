...
13. **Klassenorganisation** — Elternvertretung und Stellvertretung je Klasse, dazu Klassenlehrer:in und Klassenzimmer, die heute in `classes` keinen Platz haben. *Berührung:* rein lesend, dazu eine eigene Verknüpfung Person↔Klasse für die Elternvertretung. Klassenlehrer:in und Klassenzimmer stehen bereits als `classes.class_teacher_id` und `classes.room`, die Domäne bringt also nur die Elternvertretung mit (`domains/grenzkarte.md`, „Elternvertretung").
