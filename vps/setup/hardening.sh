#!/usr/bin/env bash
# Phase 2 — Key-Pflege + Host-Hardening (pipeline/vps-repo/02-hardening.md)
...
# TODO: verschluesseltes Swapfile via /etc/crypttab, Schluesselquelle /dev/urandom (idea/01-boot-verschluesselung.md)
# TODO: unattended-upgrades inkl. Origin-Pattern fuer download.docker.com,
...
# TODO: deploy-User anlegen (kein Root), CI-Deploy-Pubkey aus admins.yml/Runbook Schritt 5 in dessen authorized_keys
