...
**Am 03.09.2026 abgearbeitet und deshalb gestrichen:** die Aufbewahrungspflicht auf der Arbeitskopie
(DS1), die Nachweisfristen nach einer Veranstaltung und für fremde Kinder (DS6, DS7), die vier
getrennten Fristen (DS8) und fünf der sechs weiteren (DS9). Sie stehen an ihren Ankern im Schema, in
den Blöcken 03, 05, 10, 19 und 00, in `fragen.md` und `grenzkarte.md`; die Tickets TASK-058.01,
.02, .04, .05, .06 und .09 sind zu. Der wiederkehrende Ablauf — Vorwarnung, Prüfauftrag, Anhalten im
...
freiwillig, und die Freiwilligkeit muss beim Ausfüllen sichtbar sein. Offen ist, welchen Zweck jedes
