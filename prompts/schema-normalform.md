...
Ein Durchgang über alle Dateien in `schema/`, mit **genau einer** Frage: Steht jedes
...
den Katalog — er ist hier die verlässlichere Quelle als ein Dutzend Dateien im Gedächtnis:
