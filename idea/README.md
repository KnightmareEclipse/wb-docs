...
1. [Fundament & Boot-Ebene](01-boot-verschluesselung.md) — LUKS-Verschlüsselung, Dropbear-Unlock, Bus-Faktor
...
4. [Identitäts- & Zugriffs-Ebene](04-identitaet-zugriff.md) — OIDC/Entra ID, Autorisierung
5. [Backup- & Recovery-Ebene](05-backup-recovery.md) — Restic, Push-/Prune-Split, Restore-Test
