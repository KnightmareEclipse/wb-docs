...
--
-- Zwei von ihnen sind Sonderfälle: countries und languages führen neben dem frei
-- änderbaren label eine code-Spalte, deren Werte einem externen Standard gehören
-- (ISO 3166-1 alpha-3 bzw. BCP 47). Diese Listen werden geseedet, nicht von Hand
-- gepflegt; der label bleibt trotzdem frei ("Türkei"/"Türkiye"). Der Formatprüf-
-- CHECK auf code sichert deshalb Seed und Import, nicht eine laufende Eingabe.
...
CREATE TABLE classes (
    ...
    -- danach. Eine Lookup-Tabelle wäre Pflegeaufwand ohne Nutzen.
...
CREATE TABLE phone_numbers (
    ...
    -- erzeugen. Nachrüstbar, sobald die Maske normalisiert.
...
CREATE TABLE children (
    ...
    -- (rules.md Abschnitt 3). ASV-BW hält es genauso — ortsbezeichnung/ortsteil
    -- sind dort Freitext, nur der Staat ist Werteliste.
    birthplace         text,
