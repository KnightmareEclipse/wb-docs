...
- **Termine.** Putztermin, Ferien-Angebotstag und Gesprächstermin sehen ähnlich aus und sind es nicht: der eine hat eine Terminart, die die Stundenzahl mitbringt, der zweite zwei Betreuungsenden und eine Tageskapazität, der dritte ist ein Einzelslot. Eine gemeinsame Termin-Entität wäre eine Abstraktion über drei Fälle, die nichts teilen außer einem Datum.
