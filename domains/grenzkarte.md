...
- **Der Hort nimmt Kinder auf, die weder Grund- noch Realschüler sind.** Ein Betreuungsmodul kann deshalb ohne Einschreibung bestehen — dieselbe Lage wie beim Ferienprogramm-Kind (`stammdaten.md`, „Familie"), und derselbe Grund, warum es an `children` hängt und nicht an einer Klassenzuteilung. Der Hortvertrag erhebt aus genau diesem Grund den **Gesundheitsdatensatz noch einmal selbst**: für ein externes Hortkind gibt es keine Schulanmeldung, die ihn geliefert hätte. Beim Zusammenführen ist zu prüfen, dass der Satz aus Abschnitt 9 alles abdeckt, was der Nachmittag braucht — sonst fehlt dem Hort nach der Ablösung etwas, das er heute selbst abfragt. Out of scope bleibt allein der laufende **Hort-Alltag** — wer war wann da, Mittagessen je Tag —, für den der Hort eigene, sehr umfangreiche Excel-Dateien führt; sich dort einzuarbeiten lohnt den Aufwand derzeit nicht. Ebenfalls draußen: **Leihgeräte/iPads** (extern begleitet) und **Wahlpflichtfächer** (Schulalltag, Untis).
...
**Gesundheitsmerkmal (9).** Der Satz ist größer als der Schulvertrag allein: die Anmeldetag-Checklisten ergänzen Seh-/Hörschwäche sowie therapeutische Maßnahmen mit Behandlungsgrund und -zeitraum, und **derselbe Satz wird auf allen vier Checklisten, im Schulvertrag und noch einmal im Hortvertrag erhoben** — sechs Formulare, ein Datenbestand. Alle folgen demselben Muster: Merkmal vorhanden, Beschreibung, ggf. Behandlungszeitraum (von/bis, bei therapeutischen Maßnahmen real erhoben), ggf. Attest, ggf. Erlaubnis zur Verabreichung oder Durchführung. Also **eine Zeile je Merkmal mit Merkmalsart als Lookup**, nicht rund dreißig Spalten — eine weitere Merkmalsart ist damit ein Datensatz statt einer Migration, und das Spalten-GRANT der engeren DB-Rolle greift auf einer Tabelle statt auf dreißig Spalten.
