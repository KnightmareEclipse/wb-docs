...
- **Hochladen darf allein die Geschäftsführung.** Sie verantwortet die Verwaltung und besonders die Verträge; das Sekretariat liest die Vorlage, ändert sie aber nicht. Eine Rolle am Endpunkt, kein Spalten-GRANT — der Unterschied zu den vier Fällen in `domains/stammdaten.md`, „Datensichtbarkeit".
