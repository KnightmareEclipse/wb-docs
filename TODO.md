...
- [x] MFA aktivieren: Hetzner-Cloud-Konto, DNS-Provider-Konto der Schule, GitHub-Organisation (`rules.md` Abschnitt 2)
- [x] healthchecks.io-Hobbyist-Account anlegen — organisationseigen, nicht privat (`rules.md` Abschnitt 6) — Check einrichten, Zugangsdaten in KeePass ablegen
...
- [x] Subdomain wählen — `api.clemens.schule`, siehe `pipeline/runbook.md` (DNS-Schritt)
