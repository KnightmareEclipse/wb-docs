...
**Nachtrag aus den Soll-Prozessen, Elternbonus (Abschnitt 12):** Der Soll-Ablauf weicht in drei Punkten von der Papiermechanik ab (`soll-prozesse/14-elternbonus.md`). **Mitarbeiterfamilien sind ausgenommen**, kein Aufschlag und keine Stunden — die Erhebung gibt diese Ausnahme nur für den Putzdienst her; sie ist hier eine Entscheidung und keine Ableitung. Der **Stundenzettel entfällt**: Eltern tragen jede Stunde selbst ein, und was eingetragen ist, zählt — bestätigt wird nichts, die Schule vertraut den Eltern wie bisher. Was am 31. Juli nicht eingetragen ist, zählt nicht — dieselbe Härte wie beim zu spät abgegebenen Zettel. Und der **Aufruf der Einsätze wandert mit ins Portal**: Heute schreibt der Hausmeister eine Rundmail und legt je Termin eine Liste auf einer fremden Umfrageplattform an, künftig steht die Ausschreibung im Portal und erinnert am Vortag von selbst. Und die **anteilige Rückzahlung ist gedeckelt** auf das, was der Familie im Schuljahr berechnet wurde, statt eigene Regeln für Quereinsteiger und unterjährige Abgänge zu tragen; maßgeblich bleibt die Abrechnung in Optigem, unsere Zahl ist ein Vorschlag. Die Einordnung „weiterhin ausdrücklich nicht v1" ist damit überholt: Der Prozess ist in `soll-prozesse/README.md` vorgezogen.
