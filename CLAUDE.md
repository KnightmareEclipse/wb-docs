...
Das VPS-Repo ist in Phase 1–2 automatisiert: Phase 1 über das `hcloud`-CLI in `wb-vps/infra/`, Phase 2 als Ansible-Rolle `hardening`. Phase 3 (Podman, rootful) ist entschieden und noch zu bauen.
