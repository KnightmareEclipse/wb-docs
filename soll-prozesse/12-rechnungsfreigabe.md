...
- Bei **Fahrtkosten**: Datum der Fahrt, Abfahrts- und Ankunftsort, Zweck — dann entweder
  ...
  Fahrt begrenzt. **Ein Beleg trägt genau eine Fahrt**: Wer an einem Tag zwei Ziele anfährt, reicht
  zweimal ein. Eine Sammelabrechnung spart ein paar Klicks im seltenen Fall und kostet die einzige
  Bindung, die der Betrag hat — er folgt dann aus einer Summe statt aus der einen Strecke, die ihn
  ergibt.
...
denn dort gehört eine Zahlung zu mehreren Buchungen und es gibt nicht das eine Projekt. Bei einer
Aufteilung nach Vorlage steht an jedem Teil dieselbe Führungskraft, daneben der Vermerk, aus welcher
Vorlage der Schlüssel stammt. Weil das
